...
export default function Home() {
  ...
  return (
    <>
    <section className="flex flex-col items-center lg:items-start justify-center gap-4 py-0 lg:py-[8rem]">
      <div className="inline-block max-w-lg text-left text-center lg:text-start justify-center">
